...
class OpenProtocolEmulator:
    ...
    def process_message(self, msg: bytes):
        ...
        elif mid_int == 9999: print("[KeepAlive] Received keep-alive message.")
        ...
        # --- Tool Control --- Corrected Logic ---
            ...
            resp = build_message(40, rev=1) # Confirm with MID 0040
            self.send_to_client(resp)
            ...
            self.tool_enabled = True
            resp = build_message(41, rev=1) # Confirm with MID 0041
            self.send_to_client(resp)
